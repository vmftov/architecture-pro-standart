...
| :-: | :- | :- | :- | :- |
|UC1|Новый клиент,<br>Сайт,<br>Сервис данных депозитов|Просмотр предложений|1. Клиент заходит на сайт<br>2. Клиент открывает раздел депозитов<br>3. Сайт загружает список доступных депозитов со ставками и отображает их|F1
...
|UC5|Текущий (старый) клиент,<br>Интернет-банк,<br>Сервис данных депозитов|Просмотр предложений|1. Клиент заходит в интернет-банк<br>2. Клиент открывает раздел депозитов<br>3. Интернет-банк загружает список доступных депозитов с общими ставками и персональные предложения, и отображает их|F7
...
* P1, P2 - За счёт использования новых легковесных микросервисов с собственными БД и возможно кэшем, а также CDC сервиса синхронизации предложений, удастся исключить перегруженную АБС из запросов web-приложений
...
* +R4 - Для передачи сообщений используется Kafka
...
* +R10 - За счёт использования новых микросервисов для хранения данных по депозитам дополнительная нагрузка на систему скоринга не создаётся.
